...
sudo pacman -S --noconfirm --needed gnome-font-viewer gnome-system-monitor gnome-terminal gnome-tweak-tool 
...
sudo pacman -S --noconfirm --needed nemo numlockx openshot opera pamac pinta plank 
